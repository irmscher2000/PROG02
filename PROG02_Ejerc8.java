...
public class PROG02_Ejerc8 {
    ...
    public static void main(String[] args) {
       ...
       int total_Alumnos = alumnos_PROG + alumnos_ED + alumnos_BD;
       
       System.out.println("Total de alumnos matriculados: " + total_Alumnos);
       
       // Calculo los porcentajes de alumnos por modulo.
       double porcentaje_PROG = (alumnos_PROG *100) / total_Alumnos ;
       double porcentaje_ED = (alumnos_ED * 100 ) / total_Alumnos;
       double porcentaje_BD = (alumnos_BD *100 ) / total_Alumnos ;
